    ...
    return (
        <div className="h-screen flex flex-col-reverse lg:flex-row items-center justify-center lg:justify-between lg:gap-16">
            <div className="p-8 text-center lg:text-left text-lg">
                ...
                <p className="lg:text-xl py-1 lg:py-2">I&apos;m currently studying <Link className="text-primary-neutral underline" href={'https://mct.be/'} target="_blank">MCT</Link> or Multimedia &amp; Creative Technology at <Link className="text-primary-neutral underline" href={'https://www.howest.be/nl'} target="_blank">Howest</Link> in Belgium.</p>
                <div className="flex items-center gap-4 lg:gap-8 pt-4 lg:pt-10 pb-2 justify-center lg:justify-start">
                    <Link href="mailto:sybrinpypaert@gmail.com" className="bg-primary-neutral text-secundary-950 py-2 px-4 md:py-4 md:px-8 rounded-lg" >Contact me</Link>
